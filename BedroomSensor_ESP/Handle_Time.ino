...
// The standard value for the NTP polling interval is one hour. 
// This value can be changed by adding the following function definition to your sketch:
// It suffices that the definition is available in the sketch, the library will call the function automatically.

//uint32_t sntp_update_delay_MS_rfc_not_less_than_15000 ()
//{
//   return 15 * 60 * 1000UL; // 15 mins
//}
